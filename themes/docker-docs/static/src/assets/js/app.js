;(function ( $, window, document, undefined ) {
    ...
    Accordion.prototype.init = function () {
        ...
        function updateParentHeight($parentAccordion, $currentAccordion, qty, operation) {
            ...
            window.console && console.log($matched);
...
(function($) {
  ...
  $('.get-started').on('click', function(event) {
    ...
    // check the family string for common values
    // see https://github.com/bestiejs/platform.js/blob/master/doc/README.md#platformosfamily
    var isLinux = osFamily.toLowerCase().search(/Linux|Ubuntu|Debian|Fedora|Red Hat|SuSe/i);
    var isWindows = osFamily.toLowerCase().search(/Windows/i);

    // go to appropriate location for OS
    if (isWindows != -1) {
      location = '/windows/started/';
    } else if (isLinux != -1) {
      location = '/linux/started/';
    } else {
      return true;
    }
  ...
  $('.nav-docs-wrapper, .table-of-contents').stick_in_parent();
